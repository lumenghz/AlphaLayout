...
public class RocketRefreshView extends BaseRefreshView {
    ...
    public RocketRefreshView(Context context, final AlphaLayout layout) {
    ...
    protected void initialDimens(int viewWidth) {
        ...
        mSkyMoveOffset = dp2Pixel(getContext(), 15);

        mRocketTopOffset = mParent.getTotalDragDistance() * 0.1f;
        mRocketMoveOffset = dp2Pixel(mContext, 20);

        mTop = -mParent.getTotalDragDistance();

        mFireTopOffset = mParent.getTotalDragDistance() * 0.6f;
        mFireMoveOffset = dp2Pixel(mContext, 20);
    ...
    private void drawFire(final Canvas canvas) {
        ...
        drawSmallFire(canvas, mFire1, mFire1LeftOffset, offsetY, mFireScale, mFire2LeftOffset - dp2Pixel(mContext, 15), mFireTopOffset + 50);
        drawSmallFire(canvas, mFire2, mFire2LeftOffset, offsetY, mFireBurn, mFire2LeftOffset - dp2Pixel(mContext, 11), mFireTopOffset);
